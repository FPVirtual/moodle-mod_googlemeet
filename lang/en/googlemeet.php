...
$string['googleeventcreationfailed'] = 'The Google Meet room or Calendar event could not be created. The activity was saved; try saving it again later or sync it from the activity page.';
$string['hide'] = 'Hide';
...
$string['sync_trashed_recordings'] = '{$a} recording(s) moved to trash';
$string['sync_restored_recordings'] = '{$a} recording(s) restored from trash';
$string['sync_already_running'] = 'Sync already in progress. Try again in a few minutes.';
$string['sync_enrichment_queued'] = 'Transcripts, notes and permissions are being processed in the background.';
...
$string['thereisnorecordingtoshow'] = 'There are no recordings yet.';
...
$string['event_countdown_started'] = 'Started';
$string['event_countdown_starts_in_prefix'] = 'Starts in';
...
$string['room_enter_live'] = 'LIVE · Enter the room';
$string['room_enter_soon'] = 'Enter the room';
$string['room_enter_soon_countdown'] = 'Enter the room';
$string['room_enter_teacher'] = 'Prepare room · Enter';
$string['room_next_class'] = 'Next class: {$a}';
$string['room_teacher_note'] = 'Available to teaching staff to prepare the room.';
$string['url'] = '';
...
$string['recordingsorder_desc_short'] = 'Recent';
$string['recordingsorder_asc'] = 'Oldest first';
$string['recordingsorder_asc_short'] = 'Oldest';
...
$string['process_recording_enrichment_task'] = 'Process Google Meet recording enrichment';
$string['recordings_pagination_info'] = 'Showing {$a->start} to {$a->end} of {$a->total} lessons';
...
$string['ai_edit_manual'] = 'Edit analysis';
$string['ai_edit_manual_title'] = 'Edit AI Analysis';
$string['ai_edit_summary_placeholder'] = 'Enter a summary of the class…';
...
$string['hub_back_to_recordings'] = 'Back to lessons';
$string['hub_tab_summary'] = 'Summary';
...
$string['attachmentsheader'] = 'Attachments';
$string['attachments'] = 'Files for students to download';
$string['attachments_help'] = 'Upload files here (PDFs, slides, documents, etc.). Enrolled students will see them as a download list on the activity page. Leave empty to display nothing.';
...
$string['chapters_mode_reference'] = 'Reference';
$string['chapters_student_hint'] = 'Drive preview does not support jumping to a minute from Moodle; use the timestamps as a reference while watching.';
$string['chapters_teacher_hint'] = 'Select a chapter to open and highlight its timestamp in the transcript.';
...
$string['chapter_timestamp_reference'] = 'Timestamp: {$a}';
$string['chapter_transcript_highlighted'] = 'Transcript moved to {$a}';
$string['classroom_kicker'] = 'Virtual classroom';
$string['classroom_lessons'] = 'Lessons';
$string['continue_watching_cta'] = 'Continue watching';
$string['continue_watching_empty'] = 'Your next pending lesson will appear here when recordings are available.';
$string['continue_watching_empty_title'] = 'No pending lesson';
$string['continue_watching_label'] = 'Continue watching';
$string['continue_latest_cta'] = 'View class';
$string['continue_latest_label'] = 'Latest class';
$string['hero_campus_calendar_link'] = 'View in campus calendar';
$string['hero_full_schedule_link'] = 'View full schedule';
$string['hero_next_classes'] = 'Upcoming classes';
$string['hub_next_recording'] = 'Next';
$string['hub_previous_recording'] = 'Previous';
$string['lesson_has_test'] = 'Practice test';
$string['recording_embed_unavailable'] = 'This recording cannot be played embedded.';
$string['recording_hide_from_students_button'] = 'Hide from students';
$string['recording_mark_viewed'] = 'Mark as viewed';
...
$string['schedule_next_badge'] = 'Next';
$string['schedule_sync_note'] = 'Schedule set by the teaching team.';
$string['schedule_title'] = 'Class schedule';
...
$string['privacy:metadata:googlemeet_recordings:notestext'] = 'The Gemini-generated meeting notes for the recording, which may contain the names or contributions of session participants.';
$string['privacy:metadata:googlemeet_recordings:notesdocid'] = 'The Google Drive document identifier of the recording notes.';
...
$string['ytdlppath'] = 'yt-dlp path';
$string['ytdlppath_desc'] = 'Full path to the yt-dlp executable used to extract Google Drive auto-generated subtitles. Leave empty to auto-detect it from PATH, then /tmp/yt-dlp.';
...
$string['privacy:metadata:googlemeet_recording_progress'] = 'Stores each user\'s viewing progress for Google Meet recordings.';
$string['privacy:metadata:googlemeet_recording_progress:recordingid'] = 'The recording ID.';
$string['privacy:metadata:googlemeet_recording_progress:userid'] = 'The user ID.';
$string['privacy:metadata:googlemeet_recording_progress:watchedseconds'] = 'Accumulated visible-page seconds from the heartbeat proxy.';
$string['privacy:metadata:googlemeet_recording_progress:completed'] = 'Whether the recording has been marked as viewed.';
$string['privacy:metadata:googlemeet_recording_progress:timecreated'] = 'The timestamp when viewing progress was first created.';
$string['privacy:metadata:googlemeet_recording_progress:timemodified'] = 'The timestamp when viewing progress was last updated.';
$string['recordingprogress'] = 'Recording viewing progress';
...
$string['recordingavailable_subject_one'] = 'New recording available in {$a->name}';
$string['recordingavailable_subject_many'] = '{$a->count} new recordings available in {$a->name}';
$string['recordingavailable_body_one'] = 'Hi {$a->user},' . "\n\n" . 'A new recording is now available in "{$a->name}".' . "\n\n" . 'Watch it here: {$a->url}';
$string['recordingavailable_body_many'] = 'Hi {$a->user},' . "\n\n" . '{$a->count} new recordings are now available in "{$a->name}".' . "\n\n" . 'Watch them here: {$a->url}';
$string['recordingnotificationsubscription'] = 'Recording notification subscription';
$string['subscriberecordings'] = 'Get alerts';
$string['unsubscriberecordings'] = 'Stop alerts';
$string['ai_status_chip_processing'] = 'Analysis in progress';
$string['ai_status_chip_pending'] = 'Analysis queued';
$string['ai_status_chip_failed_student'] = 'Analysis unavailable';
$string['ai_status_chip_failed_teacher'] = 'Analysis error';
$string['ai_badge_label'] = 'AI analysis';
$string['recording_watch_cta'] = 'Open class';
$string['recording_new'] = 'New';
$string['recording_view_summary'] = 'View summary';
$string['recording_play_aria'] = 'Open recorded class';
$string['recordings_search_label'] = 'Search classes';
$string['recordings_search_placeholder'] = 'Search lessons…';
$string['recordings_search_placeholder_student'] = 'Search lessons…';
$string['recordings_search_button'] = 'Search';
$string['recordings_filter_clear'] = 'Clear filters';
$string['recordings_filter_all_topics'] = 'All topics';
$string['recordings_no_filter_results'] = 'No recordings match the current filters.';
...
$string['recording_restore'] = 'Restore';
$string['recording_purge'] = 'Delete permanently';
$string['recording_purge_confirm'] = 'Delete this recording permanently? Its AI analysis and attached materials will also be removed.';
$string['recording_trash'] = 'Delete';
$string['recording_trash_aria'] = 'Move recording to trash';
$string['recording_trash_confirm'] = 'This recording will be moved to the trash. You can restore it later.';
$string['recording_rename'] = 'Rename recording';
$string['recordings_view_label'] = 'View';
$string['recordings_view_cards'] = 'Cards';
$string['recordings_view_list'] = 'List';
$string['recordings_view_cards_aria'] = 'View recordings as cards';
$string['recordings_view_list_aria'] = 'View recordings as a list';
$string['materials_more'] = '+{$a} more';
$string['materials_more_aria'] = 'View {$a} more materials';
$string['question_discard_confirm'] = 'Discard this draft question?';
$string['question_bulk_discard_confirm'] = 'Discard the selected draft questions?';
$string['question_unpublish_confirm'] = 'Unpublish this question? Students will no longer see it.';
