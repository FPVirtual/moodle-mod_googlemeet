...
$string['chapters_student_hint'] = 'La vista previa de Drive no permite saltar a un minuto desde Moodle; usa los tiempos como referencia mientras ves la clase.';
$string['chapters_teacher_hint'] = 'Selecciona un capítulo para abrir y resaltar su marca temporal en la transcripción.';
...
$string['ytdlppath_desc'] = 'Ruta completa al ejecutable yt-dlp usado para extraer subtítulos generados automáticamente de Google Drive. Déjala vacía para detectarlo desde PATH y, después, probar /tmp/yt-dlp.';
...
$string['recordingavailable_subject_one'] = 'Nueva grabación disponible en {$a->name}';
$string['recordingavailable_subject_many'] = '{$a->count} nuevas grabaciones disponibles en {$a->name}';
$string['recordingavailable_body_one'] = 'Hola {$a->user},' . "\n\n" . 'Ya tienes disponible una nueva grabación en «{$a->name}».' . "\n\n" . 'Verla aquí: {$a->url}';
$string['recordingavailable_body_many'] = 'Hola {$a->user},' . "\n\n" . 'Ya tienes disponibles {$a->count} nuevas grabaciones en «{$a->name}».' . "\n\n" . 'Verlas aquí: {$a->url}';
